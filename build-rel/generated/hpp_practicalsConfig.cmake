...
if(NOT hpp_practicals_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${hpp_practicals_FIND_COMPONENTS})
    if(NOT "hpp_practicals_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("hpp_practicals_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("HPP_PRACTICALS_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("hpp_practicals_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/hpp_practicals/doxygen-html")
set("HPP_PRACTICALS_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/hpp_practicals/doxygen-html")
set("hpp_practicals_DEPENDENCIES" "")
set("hpp_practicals_PKG_CONFIG_DEPENDENCIES" "omniORB4;omniORB4 >= 4.1.4;omniDynamic4 >= 4.1.4;openscenegraph >= 3.2;openthreads >= 2.6;openscenegraph-osgQt5;qgv")
...
set("_hpp_practicals_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_hpp_practicals_PKG_CONFIG_LIBS_LIST" "")
if(_hpp_practicals_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_hpp_practicals_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _hpp_practicals_PKG_CONFIG_LIBS_LIST "${_hpp_practicals_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_hpp_practicals_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _hpp_practicals_PKG_CONFIG_LIBS_LIST "${_hpp_practicals_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_hpp_practicals_PKG_CONFIG_LIBDIR})
  foreach(component ${_hpp_practicals_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_hpp_practicals_PKG_CONFIG_LIBS_LIST)

set("hpp_practicals_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("HPP_PRACTICALS_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${hpp_practicals_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/hpp_practicalsTargets.cmake")
...
foreach(component ${hpp_practicals_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(hpp_practicals_${component}_FOUND FALSE)
  endif()
  if(hpp_practicals_${component}_FOUND)
    message(STATUS "hpp_practicals: ${component} found.")
  else()
    if(hpp_practicals_FIND_REQUIRED_${component})
      message(FATAL_ERROR "hpp_practicals: ${component} not found.")
    else()
      message(STATUS "hpp_practicals: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("hpp_practicals")
